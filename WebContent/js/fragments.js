        ...
        sap.ui.jsfragment('FooterToolbar', {
            createContent: function(params) {
                ...
                var nextButton = new sap.m.Button(this.createId('footerNextButton'), {
                    ...
                    width: params.showGoToStart || params.actionCallback ? '33%' : '50%',
                ...
                if(params.showGoToStart){
                	prevButton.addStyleClass('footerButton footerPrevButtonWithGoToStartButton');	
                }
                else{
                	prevButton.addStyleClass('footerButton footerPrevButton');	
                }
                ...
                var goToStartButton; 
                if (params.showGoToStart) {
                	goToStartButton = new sap.m.Button(this.createId('footerGoToStartButton'), {
	                    icon: 'images/goToStart.png',
	                    enabled: false,
	                    iconDensityAware: false,
	                    width: '33%',
	                    press: function() {
	                       ...
	                       var pages = nav.getPages();
	                        ...
	                        nav.backToPage("page_1" );
	                    }
	                }).addStyleClass('footerButton footerGoToStartButton');
                }
                ...
                var toolbar = new sap.m.Toolbar(this.createId('footerToolbar'), {
                    content: [goToStartButton, prevButton, actionButton, nextButton]
